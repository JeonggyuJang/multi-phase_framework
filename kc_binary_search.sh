...
#for prune_rate in 10 20 30 40 50 75 78.125 81.25 82.8125 84.375 87.5 93.75 94.53125 95.3125
...
#for prune_rate in 10 20 30 40 50 
#do
#	python multi_phase_network_framework.py --P 1 --R 1 --Model VGG7 --Train_Batch 32 --Dataset 10 --T_Epoch 240 --LR_step 40 80 120 160 200 --P_rate $prune_rate --lr 0.01 --Method kc --with_fc t --Dev $dev_num --Vis f --momentum 0.1
#done


#for prune_rate in 99 95 90 85 80 75 70 65 60 55
#for prune_rate in 0 10 20 30 40 50 75 78.125 81.25 82.8125 84.375 87.5 93.75 94.53125 95.3125

#for prune_rate in 10
for prune_rate in 50 75 87.5 93.75 96.875 95.3125 94.53125  
#for prune_rate in 83.46098 
#for prune_rate in 94.53125
do
	python multi_phase_network_framework.py --P 1 --R 1 --Model VGG7 --Train_Batch 64 --Dataset 10 --T_Epoch 240 --LR_step 40 80 120 160 200 --P_rate $prune_rate --lr 0.005 --Method kc --with_fc t --Dev $dev_num --Vis f --momentum 0.9
done
