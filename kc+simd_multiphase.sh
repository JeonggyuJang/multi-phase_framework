...
#### Count4 fine tuning...
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 32 --T_Epoch 240 --LR_step 40 80 120 160 200 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 4 --Mask 84-65-53-25 --dP_rate 100 --init_from 65 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.1 --momentum 0.1
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 64 --T_Epoch 300 --LR_step 50 100 150 200 250 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 4 --Mask 84-65-53-25 --dP_rate 100 --init_from 65 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.1 --momentum 0.9
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 32 --T_Epoch 280 --LR_step 40 80 120 160 200 240  --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 4 --Mask 84-65-53-25 --dP_rate 100 --init_from 65 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.2 --momentum 0.5
...
#### Count7 fine tuning...
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 64 --T_Epoch 240 --LR_step 40 80 120 160 200 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 7 --Mask 84-65-53-25-100-8-62 --dP_rate 25 --init_from 8 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.1 --momentum 0
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 64 --T_Epoch 240 --LR_step 40 80 120 160 200 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 7 --Mask 84-65-53-25-100-8-62 --dP_rate 25 --init_from 8 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.1 --momentum 0
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 32 --T_Epoch 280 --LR_step 40 80 120 160 200 240 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 7 --Mask 84-65-53-25-100-8-62 --dP_rate 25 --init_from 8 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.2 --momentum 0.5

#### Count8 fine tuning...
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 64 --T_Epoch 240 --LR_step 40 80 120 160 200 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 8 --Mask 84-65-53-25-100-8-62-25 --dP_rate 100 --init_from 8 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.1 --momentum 0.5
#python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 128 --T_Epoch 300 --LR_step 50 100 150 200 250 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 8 --Mask 84-65-53-25-100-8-62-25 --dP_rate 100 --init_from 8 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.1 --momentum 0.1
python combined_network_framework.py --P 2 --R 1 --M 1 --Dataset 100 --Train_Batch 32 --T_Epoch 280 --LR_step 40 80 120 160 200 240 --lr 0.1 --Method kc+simd --with_fc t --Dev $dev_num --M_count 8 --Mask 84-65-53-25-100-8-62-25 --dP_rate 100 --init_from 8 --Model VGG11_CIFAR_BIG --Vis f --kc_or_simd simd --gamma 0.2 --momentum 0.7
