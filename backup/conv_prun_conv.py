...
from models import ConvNet_prun_conv

# Name of NN
NN_name = 'conv_prun_conv'
...
net2 = ConvNet_prun_conv() #----------------------------------rewrite!!
...
# prune the weights
masks = weight_prune(net2, param['pruning_perc'])
...
train(net2, criterion2, optimizer2, param, loader_train)
